...
export default function SliderFrame() {
  ...
  return (
    <div id='portfolio'>
      <div className='bg-[#000000] pt-[5rem] pb-[9rem] px-[14rem] max-medium:px-[5rem]  max-medium:pb-[6rem] max-medium:pt-[4rem]  max-small:pt-[2rem] max-extraSmall:px-[3.5rem] max-verySmall:px-[2rem] max-small:pb-[7rem]  relative'>
