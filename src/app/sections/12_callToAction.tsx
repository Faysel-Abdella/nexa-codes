    ...
    <section className="mt-10">
      <div className="relative ">
        <Image
          ...
          loading="lazy"
          alt="call-to-action"
          className="h-[550px] medium:h-[650px] max-medium:h-[400px] max-small:h-[320px] max-extraSmall:h-[280px] w-full object-cover overflow-hidden "
        />
              ...
              <span
                className=" text-[40px]
                  ...
                  max-extraSmall:text-[16px]
                   whitespace-nowrap  text-slate-50 font-bold block"
              >
                찾지 말고 넥사코드에 연락하세요!
              </span>
            </p>
            ...
            >
              <span
                className="text-slate-50
                  ...
                  max-extraSmall:text-[12px]     font-['Noto Sans KR']"
              >
                상담 신청하러가기
              </span>
              ...
              <Image
                ...
                loading="lazy"
                alt="right arrow"
                className="w-[30px] max-small:w-[20px] max-extraSmall:w-[16px]"
              />
